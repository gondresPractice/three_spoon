...
class _ApiService implements ApiService {
  ...
  @override
  Future<CreateCustomerResponse> createNewCustomer(
    String name,
    String gender,
    int phone,
  ) async {
  ...
  Future<OrderProductResponse> createNewOrder(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<OrderProductResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/x-www-form-urlencoded',
    ...
    final value = OrderProductResponse.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<OrderProductResponse> changeStatusPay(int orderId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
